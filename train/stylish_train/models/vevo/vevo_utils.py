...
class VevoInferencePipeline:
    ...
    def init_vqvae_tokenizer(self):
        ...
        ckpt_path = getattr(
            ...
            "pretrained_path",
            str(self.content_tokenizer_ckpt_path.resolve()),
        )
        ...
        ckpt_path = getattr(
            ...
            "pretrained_path",
            str(self.content_style_tokenizer_ckpt_path.parent.resolve()),
        )
    ...
    def extract_hubert_quantized(
        ...
        if token_type == "hubert_codec":
            ...
            _, idx = vqvae_model.quantizer.codebook.forward_index(z.transpose(2, 1))
            z = vqvae_model.quantizer.codebook.lookup(idx.cpu()).transpose(-1, -2)
        else:
            raise ValueError("Invalid token_type")
