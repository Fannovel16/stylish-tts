...
stages = {
    ...
    "pre_hubert_quantizer": StageConfig(
        next_stage="pre_feature_synthesizer",
    ...
    "pre_feature_synthesizer": StageConfig(
        next_stage=None,
        train_fn=train_pre_feature_synthesizer,
        validate_fn=validate_pre_feature_synthesizer,
